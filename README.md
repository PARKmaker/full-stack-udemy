...
export default mongoose.model('job.jsx', JobSchema);
```
...
import Job from '../models/job.jsx.js';
...
import { Link } from 'react-router-dom';
import Wrapper from '../assets/wrappers/job.jsx';
...
export const action = async ({ request, params }) => {
  ...
  try {
    ...
    toast.success('job.jsx edited successfully');
    return redirect('/dashboard/all-jobs');
  } catch (error) {
    toast.error(error.response.data.msg);
    return error;
